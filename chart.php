...
$fields = [
	...
	'timeZone' => 		[T_ZBX_STR,			O_OPT, null,	null,		null], // Добавленный параметр часового пояса
...
// Обработка параметра часового пояса
if (hasRequest('timeZone') && getRequest('timeZone') !="") {
	date_default_timezone_set(getRequest('timeZone'));
}
